...
public class AIController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            BattlePosition = GamePlayer_Selection.instance.gameplayer.transform.position;
        }
       // BattlePosition = Target.transform.position;
        timestatetemp = 0;
         ...
         // Ok in range
            ...
            {// is in Direction ?
             // Ok Can Shoot them.
                ...
                if (distance < 100)// change this value DistanceAttack / 3 if 100 didnt work
